...
from masking.base_operations.operation_word_match_dict import WordMatchDictOperationBase
from masking.mask.operations.operation import PandasOperation


class WordMatchDictOperation(PandasOperation, WordMatchDictOperationBase):
